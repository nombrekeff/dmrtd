...
class DBAKey extends AccessKey {
  ...
  /// Constructs [DBAKey] using passport number [mrtdNumber],
  /// passport owner's [dateOfBirth] and passport [dateOfExpiry].
  /// If [paceMode] is true, then the key seed length will be set to PACE length. 
  /// 
  ///  This constructor is used when the date of birth and date of expiry
  /// are provided as strings in the format "YYMMDD".
  DBAKey.fromStrings(String mrtdNumber, String dateOfBirth, String dateOfExpiry,
      {bool paceMode = false}) {
    _mrtdNum = mrtdNumber;
    _dob = dateOfBirth;
    _doe = dateOfExpiry;
